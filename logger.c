...
void
log_add(Logger * l, int level, const char *msg)
{
	if(level < l->level)
		return;
...
void
log_debug(Logger * l, const char *fmt, ...)
{
	va_list ap;
...
void
log_info(Logger * l, const char *fmt, ...)
{
	va_list ap;
	char    msg[LOG_MAX_MSG_LEN];
...
void
log_warn(Logger * l, const char *fmt, ...)
{
	va_list ap;
	char    msg[LOG_MAX_MSG_LEN];
...
void
log_error(Logger * l, const char *fmt, ...)
{
	va_list ap;
	char    msg[LOG_MAX_MSG_LEN];
